      ...
      <div id="gallery">
        <figure>
          ...
          <ul class="nospace clear">
            <li v-for="(vo,index) in food_list" :class="index%4==0?'one_quarter first':'one_quarter'"><a :href="'../food/food_list_detail.do?fno='+vo.fno"><img :src="'http://www.menupan.com/'+vo.poster" :title="vo.name" alt=""></a></li>
          </ul>
